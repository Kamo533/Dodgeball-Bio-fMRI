...
public class GameLogger : MonoBehaviour
{
    ...
    public void Start()
    {
        ...
        logsFolderName = Path.Combine(System.IO.Directory.GetCurrentDirectory(), "Assets/Dodgeball/Logs/fMRI_2024-02-27"); //"Assets/Dodgeball/Logs");
